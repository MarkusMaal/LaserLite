...
if(mysqli_connect_errno($connection)) {
  ...
  $tables = array();
    ...
    backup_database($connection, $tables, $backup_file_name);
  }
?>

<?php
function backup_database($connection, $tables = "", $backup_file_name) {

  if(empty($tables)) {
    $tables_in_database = mysqli_query($connection, "SHOW TABLES");
  ...
  foreach($tables as $table) {
    ...
    $table_query     = mysqli_query($connection, "SHOW CREATE TABLE ".$table);
