...
<?php
	if (($_SERVER["REQUEST_URI"] != "/channel_db/ideas/index.php") && ($_SERVER["REQUEST_URI"] != "/channel_db/ideas/")) {
		...
		echo '" class="funsymbols" href="report' . str_replace("/channel_db/ideas/", "/", $_SERVER["REQUEST_URI"]) . '&nopages=1">&#128215;</a>';
		echo '<a title="';
		if ($l == "et-EE") { echo 'Salvesta raport'; } else { echo 'Save report'; }
		echo '" class="funsymbols" href="save_head.php' . str_replace("channel_db/ideas/index.php", "", $_SERVER["REQUEST_URI"]) . '&nopages=1">&#128190;</a>';
	}
?>
<br/><br/>
